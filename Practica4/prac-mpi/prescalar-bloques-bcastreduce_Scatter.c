    ...
    if (idproc == 0) {
	 ...
	 b[i]=(double) i;
       ...
       //for (i=1; i<numprocs; i++) {
          /* Difundimos el tamaño del problema */
			/*Usando directivas colectivas*/
          ...
          printf("Soy %d. Enviando a %d el dato %d\n",idproc, i, cadaproc);*/
            ...
            /* Difundimos los datos a todos los procesadores */
			
			MPI_Bcast(&a, vsize, MPI_DOUBLE, 0, MPI_COMM_WORLD);
